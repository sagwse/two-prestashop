 ...
 * Bootstrap    : 5.3
 * Файл         : modules/ps_featuredproducts/views/templates/hook/ps_featuredproducts.tpl
 *}
<section class="featured-products featured-section py-5">
  <div class="container-fluid px-0">
    <div class="featured-section__header d-flex align-items-center justify-content-between mb-4">
      ...
      <a href="{$allProductsLink}" class="btn btn-outline-primary btn-sm">
