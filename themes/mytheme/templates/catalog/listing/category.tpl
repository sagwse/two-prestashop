...
{block name='content'}
    ...
    <div class="container-fluid px-0">
      ...
      {if isset($category.image.large.url) && $category.image.large.url}
        <img
          ...
          src="{$category.image.large.url|escape:'html':'UTF-8'}"
              ...
              >
                ...
                {if isset($subcategory.image.small.url) && $subcategory.image.small.url}
                  <div class="subcategory-tile__img-wrapper">
                    <img
                      src="{$subcategory.image.small.url|escape:'html':'UTF-8'}"
  ...
  {* ── 6. OFFCANVAS: ФИЛЬТРЫ (мобильный/планшетный вид) ───────────────────────
     ...
     ─────────────────────────────────────────────────────────────────────────── *}
  <div
    class="offcanvas offcanvas-start catalog-filters-offcanvas"
    tabindex="-1"
  ...
  >
    <div class="offcanvas-header">
      ...
      <button
        ...
        aria-label="{l s='Закрити фільтри' d='Shop.Theme.Catalog'}"
      ></button>
    </div>
    ...
    <div class="offcanvas-footer">
      <button
        type="button"
        class="btn btn-primary w-100 catalog-filters-apply-btn"
        data-bs-dismiss="offcanvas"
  ...
  >
    <div class="container-fluid px-0">
      <div class="catalog-toolbar__inner">
        ...
        <button
          class="catalog-toolbar__filters-btn d-lg-none"
          type="button"
        ...
        >
          ...
          {if $active_filters_count > 0}
            <span
              class="catalog-toolbar__filters-badge"
              aria-label="{l s='Активних фільтрів: %count%' sprintf=['%count%' => $active_filters_count] d='Shop.Theme.Catalog'}"
        ...
        {if isset($listing.sort_orders) && $listing.sort_orders|@count > 0}
          <div class="catalog-toolbar__sort">
            <label
              for="catalog-sort-select"
              class="catalog-toolbar__sort-label visually-hidden"
            >
            ...
            <div class="catalog-toolbar__sort-wrapper">
              ...
              >
                {foreach from=$listing.sort_orders item='sort_order'}
                  <option
                    value="{$sort_order.url_parameter|escape:'html':'UTF-8'}"
        ...
        <div
          class="catalog-toolbar__view-toggle"
          role="group"
          aria-label="{l s='Вид відображення товарів' d='Shop.Theme.Catalog'}"
        >
          <button
            type="button"
            class="catalog-toolbar__view-btn catalog-toolbar__view-btn--grid"
            id="js-view-grid"
            aria-pressed="true"
            title="{l s='Сітка' d='Shop.Theme.Catalog'}"
            data-view="grid"
          >
          ...
          <button
            type="button"
            class="catalog-toolbar__view-btn catalog-toolbar__view-btn--list"
            id="js-view-list"
            aria-pressed="false"
            title="{l s='Список' d='Shop.Theme.Catalog'}"
            data-view="list"
          >
        ...
        {if isset($listing.pagination.total_items)}
          <p
            class="catalog-toolbar__counter"
            aria-live="polite"
            aria-atomic="true"
  ...
  <div class="catalog-layout">
    <div class="container-fluid px-0">
      <div class="catalog-layout__inner">
        ...
        {if $has_left_column}
          <aside
            class="catalog-layout__aside"
            aria-label="{l s='Фільтри товарів' d='Shop.Theme.Catalog'}"
          >
            ...
            {if isset($listing.active_filters) && $listing.active_filters|@count > 0}
              <div class="catalog-active-filters">
                <div class="catalog-active-filters__header">
                  ...
                  <a
                    href="{$listing.reset_filters_url|default:$category.url|escape:'html':'UTF-8'}"
